...
# uncomment the next 2 lines to solve part 1
...
first_bit = tower_heights[data.index(iteration_data) - 1]
repeated_bit = tower_heights[-1] - first_bit
len_first_bit = data.index(iteration_data)
len_repeated_bit = len(tower_heights) - len_first_bit
answer = first_bit + repeated_bit * (NB_ITERATIONS - len_first_bit) // len_repeated_bit
print(answer)
