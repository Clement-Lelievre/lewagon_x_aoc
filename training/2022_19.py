...
def compute_max_nb_geodes(recipe: str, ore: int = 1, time: int = 24) -> int:
    price_data = price_extractor.search(recipe)
    ore_robot_price = int(price_data.group(1))
    clay_robot_price = int(price_data.group(2))
    obsidian_robot_price = (
        int(price_data.group(3)) + int(price_data.group(4)) * clay_robot_price
    )
    geode_robot_price = (
        int(price_data.group(5)) + int(price_data.group(6)) * obsidian_robot_price
    )
